public class implementacion6 extends abs6 {

    @Override
    public void push(int elemento) {
        nodo6 nuevo = new nodo6(elemento);
    ...
    private void merge(int[] a, int i, int m, int d) {
        int[] L = java.util.Arrays.copyOfRange(a, i, m + 1);
        int[] R = java.util.Arrays.copyOfRange(a, m + 1, d + 1);
        int x = 0, y = 0, k = i;
